...
_SIMULATE_HOSTINFO = {
    4: {
        ...
        "network": {
            "cidr": "192.0.2.0/24",
            "comment": "Main Campus Eduroam NAT",
            "ip_version": "4",
            "netmask": "255.255.255.0",
            "prefixlen": "24",
            "contact": "demo",
            "contact_name": "Demo Administrator",
            "contact_email": "demo@unc.edu",
            "contact_dept": "ITS",
            "cost_center": None,
            "purpose": "Wireless",
        ...
        "nac": {
            "endSystem": {
                ...
                "wireless_ap_name": "ITS-DEMO-AP-001",
...
def hostinfo() -> Response:
    ...
    if simulate:
        ...
        elif simulate == "oncampus6":
            sim_data = dict(_SIMULATE_HOSTINFO[6])
        else:
            # "oncampus" is canonical; legacy "4"/"6"/"1" all fall back to campus IPv4.
